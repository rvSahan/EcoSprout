...
public class JavaMailAPI extends AsyncTask<Void, Void, String> {
    private final String senderEmail = "Use your email"; // Use your email
    private final String senderPassword =  "Use generated App Password"; // Use generated App Password
